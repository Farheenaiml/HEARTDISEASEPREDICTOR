...
# Custom CSS: Soft gradient background, glassmorphism cards, and heart animation
st.markdown("""
<style>
body {
...
# User Inputs in glassmorphic card
...
# Predict button in glass-card
st.markdown("<div class='glass-card'>", unsafe_allow_html=True)
if st.button("Predict"):
    # Loading animation + gradient progress bar
